...
//               </div>
//               <div>
//                 <h1 className="text-5xl font-bold text-red-600 mb-1">VRT</h1>
//                 <p className="text-base text-black dark:text-neutral-300 mb-1">Management Group</p>
//                 <p className="text-sm text-black dark:text-neutral-400">Inspire • Action • Growth</p>
//                 <h2 className="text-4xl font-bold text-red-600 mt-4">Time Boxing</h2>
//               </div>
//             </div>
...
//                   <CardHeader className="bg-red-600 text-white py-3 px-4">
